  ...
  return (
    <footer className="mt-16 bg-neutral-950 text-neutral-300">
      ...
      <div className="border-t border-neutral-800">
        <p className="mx-auto max-w-7xl px-4 py-5 font-sans text-xs text-neutral-500">
          © 2026 {SITE.name} — Testata giornalistica in fase di registrazione. Tutti i diritti riservati.
        </p>
      </div>
    </footer>
  );
